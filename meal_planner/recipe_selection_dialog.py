...
This module defines the RecipeSelectionDialog class, a modal dialog that lets users pick a recipe via the
ViewRecipes widget. Instead of emitting its own signal, the dialog listens for the ViewRecipes widget's 
`recipe_selected` signal. When a recipe is selected, the dialog records the recipe ID and closes.
"""

# 🔸 Third-party Imports
from qt_imports import QDialog, QVBoxLayout

# 🔸 Local Application Imports
from app.view_recipes import ViewRecipes

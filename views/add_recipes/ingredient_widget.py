...
from PySide6.QtWidgets import QApplication, QGridLayout, QLineEdit, QWidget, QHBoxLayout, QFrame
...
class IngredientWidget(WidgetFrame):
    ...
    def __init__(self, removable=True, parent=None):
        super().__init__(layout_type="grid", parent=parent)
    ...
    def _setup_ui(self):
        ...
        self.add_widget(self.btn_ico_subtract, 0, 4, 1, 1)
        ...
        self.add_widget(self.btn_ico_add, 0, 5, 1, 1)

...
# dytnamic_validation()         -> Real-time validation for QLineEdit
#
...
# apply_error_style()         -> Highlight field with error style
# clear_error_styles()        -> Clear error styling from field
#
...
__all__ = [
    # Form Validation
    'validate_form_field', 'validate_required_fields', 'clear_validation_errors', 'dynamic_validation',

    # Data Collection & Serialization
    'collect_form_data', 'populate_form_from_data',

    # Form State Management
    'clear_form_fields', 'reset_form_to_defaults', 'set_form_enabled_state', 'apply_error_style', 'clear_error_styles',

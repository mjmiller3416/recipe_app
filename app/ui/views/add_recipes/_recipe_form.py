"""app/ui/views/add_recipes/_recipe_form.py

This module defines the RecipeForm class, which provides a structured form layout
for adding or editing recipes, including fields for recipe name, time, servings,
meal type, category, and dietary preferences.
"""

# ── Imports ──
from PySide6.QtWidgets import QWidget
from app.ui.utils import create_labeled_form_grid

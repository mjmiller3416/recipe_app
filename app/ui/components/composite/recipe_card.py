...
class LargeRecipeCard(BaseRecipeCard):
    ...
    def _build_recipe_layout(self) -> QWidget:
        ...
        from app.ui.components.composite.recipe_info_cards import RecipeInfoCards
        ...
        content_layout.addWidget(image_overlay, 0)
        ...
        # Ingredients Preview
        ingredients_preview = IngredientsPreview(max_preview_items=5)

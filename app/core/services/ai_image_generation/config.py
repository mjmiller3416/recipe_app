...
class ImageGenConfig:
    ...
    # "gpt-image-1"  - Latest model, good quality (more expensive)
    # "dall-e-3"     - Previous generation, good quality (less expensive)  
    # "dall-e-2"     - Older model, lower quality (cheapest)

...
# Description: This file contains a custom logger class that enhances the built-in logging module with color support and
# context-aware logging. The DebugLogger class provides methods to log messages with different log levels (debug, info, warning,
# error, critical) and dynamically replace variables in the log message with their values from the caller's local scope. It also

...
Defines the RecipeWidget class that acts as a dynamic container for different recipe states (empty, recipe, error).
"""
...
class RecipeWidget(QFrame):
    ...
    def set_recipe(self, recipe: Recipe | None) -> None:
        """Load or clear a recipe in this `RecipeWidget`.
        Args:
        ...
        try:
            ...
            print(f"[RecipeWidget] Failed to build card: {exc}")

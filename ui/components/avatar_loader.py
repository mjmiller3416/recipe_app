"""ui\components\avatar_loader.py
...
from ui.components import CropDialog
from ui.widgets.ct_icon import CTIcon
from ui.widgets import CircularImage
...
class AvatarLoader(QWidget):
    ...
    def set_avatar_from_path(self, temp_file_path: str):
        ...
        perm = profile_dir / f"avatar_{uuid.uuid4().hex}.png"
        shutil.copy(temp_file_path, perm)

        self.settings.set("avatar_path", str(perm))
        self.avatar_display.setPixmap(QPixmap(str(perm)))
